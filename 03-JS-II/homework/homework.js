...
function colors(color) {
  ...
  switch (color) {
    ...
    case "green":
      ...
      break;
    case "orange":
      texto = "This is orange";
      break;
    default:
      texto = "Color not found";
  }
  return texto;
}
...
function fizzBuzz(numero) {
  ...
  if((numero % 15)===0){texto = "fizzbuzz";}
  if((numero % 3)!==0 && (numero % 5)!==0 && (numero % 15)!==0) {return numero;}
  return texto;
}
...
function tablaDelSeis(){
  ...
  let Vect=[0, 6, 12, 18, 24, 30, 36, 42, 48, 54, 60];
  return Vect;
  /*for(var i=0;i<=10;i++)
  {
    Vect[i]=Vect[i]*6;
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  var redond = Math.floor(numero/100);
  if(redond >= 1 && redond <= 9){return true;}
  else{return false;}
